// Test script for Flier email endpoints
// This script can be run in the browser console or with Node.js

console.log("🧪 Flier Email Endpoint Tests");
...
async function testSingleEmailEndpoint() {
  ...
  const testPayload = {
    ...
    message:
      "<html><body><h1>Test Message</h1><p>This is a test email from the single email endpoint.</p></body></html>",
    originalRowData: {
...
function testPayloadSizes() {
  ...
  const baseSizes = [
    { name: "Minimal", subject: "Test", message: "<p>Hi</p>" },
    {
      ...
      message: "<p>Short test message</p>",
    },
    {
      name: "Medium",
      subject: "Test Subject - Medium Length",
      message:
        "<html><body><h1>Test</h1><p>This is a medium length test message with some HTML content.</p></body></html>",
    },
    {
      name: "Large",
      subject: "Test Subject - Large Content",
      message:
        "<html><body><h1>Large Test</h1><p>This is a large test message with lots of content. ".repeat(
          100,
        ) + "</p></body></html>",
    },
  ];
