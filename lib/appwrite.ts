...
export interface Contact {
  ...
  company?: string;
  phone?: string;
  tags?: string[]; // Custom tags for organization (stored as JSON string in Appwrite)
  user_email: string;
  created_at?: string;
}
...
export interface TemplateVersion {
  ...
  user_email: string;
  created_at: string;
  change_note?: string; // Optional note describing what changed
}
...
export const contactsService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: Contact[] }> {
  ...
  async update(
    contactId: string,
    data: Partial<Omit<Contact, "$id" | "user_email" | "created_at">>,
  ) {
    return apiRequest<Contact>("/api/appwrite/contacts", {
      method: "PUT",
...
export const templatesService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: EmailTemplate[] }> {
  ...
  async getVersions(
    ...
    return apiRequest(
      `/api/appwrite/templates/versions?templateId=${templateId}`,
    );
  },
...
export const contactGroupsService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: ContactGroup[] }> {
  ...
  async update(
    groupId: string,
    data: Partial<Omit<ContactGroup, "$id" | "user_email" | "created_at">>,
  ) {
    return apiRequest<ContactGroup>("/api/appwrite/contact-groups", {
      method: "PUT",
...
export const draftEmailsService = {
  async create(
    email: Omit<
      DraftEmail,
      "$id" | "created_at" | "sent_at" | "user_email" | "status"
    >,
  ) {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: DraftEmail[] }> {
  ...
  async update(
    emailId: string,
    data: Partial<
      Omit<DraftEmail, "$id" | "user_email" | "created_at" | "status">
    >,
  ) {
    return apiRequest<DraftEmail>("/api/appwrite/draft-emails", {
      method: "PUT",
...
export const signaturesService = {
  async create(
    signature: Omit<
      EmailSignature,
      "$id" | "created_at" | "updated_at" | "user_email"
    >,
  ) {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: EmailSignature[] }> {
  ...
  async update(
    signatureId: string,
    data: Partial<Omit<EmailSignature, "$id" | "user_email" | "created_at">>,
  ) {
    return apiRequest<EmailSignature>("/api/appwrite/signatures", {
      method: "PUT",
...
export const unsubscribesService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: Unsubscribe[] }> {
...
export const webhooksService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: Webhook[] }> {
    return apiRequest("/api/appwrite/webhooks");
  },

  async update(
    webhookId: string,
    data: Partial<Omit<Webhook, "$id" | "user_email" | "created_at">>,
  ) {
    return apiRequest<Webhook>("/api/appwrite/webhooks", {
      method: "PUT",
...
export const abTestsService = {
  ...
  async listByUser(
    _userEmail: string,
  ): Promise<{ total: number; documents: ABTest[] }> {
