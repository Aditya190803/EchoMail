...
export default function DebugPage() {
  const [appwriteStatus, setAppwriteStatus] = useState<'loading' | 'success' | 'error' | 'untested'>('untested')
  ...
  const envVars = [
    ...
    { name: "APPWRITE_PROJECT_ID", value: process.env.NEXT_PUBLIC_APPWRITE_PROJECT_ID || "Not set" },
    { name: "APPWRITE_DATABASE_ID", value: process.env.NEXT_PUBLIC_APPWRITE_DATABASE_ID || "Not set" },
  ]
  ...
  const testDatabase = async () => {
    ...
    try {
      ...
      setAppwriteError(error instanceof Error ? error.message : 'Unknown error')
    }
  }
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button 
                ...
                variant="outline"
              >
                <RefreshCw className={`h-4 w-4 mr-2 ${appwriteStatus === 'loading' ? 'animate-spin' : ''}`} />
                Test Connection
              </Button>
            </div>
          </CardHeader>
            ...
            {appwriteStatus === 'success' && (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                  <div className="text-sm font-medium text-blue-900">Connection Status</div>
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>Ensure your Appwrite database and collections are created</li>
