      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        <Card className="shadow-lg border-0">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-2xl sm:text-3xl font-bold mb-2">Terms of Service</CardTitle>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Account Creation:</strong> You must sign in with a valid Google account to use our Service. 
                    You are responsible for maintaining the security of your account.
                  </p>
                  <p>
                    <strong className="text-foreground">Accurate Information:</strong> You agree to provide accurate, current, and complete 
                    information about yourself as prompted by our sign-in process.
                  </p>
                  <p>
                    <strong className="text-foreground">Account Responsibility:</strong> You are responsible for all activities that occur under 
              ...
              <section>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg font-semibold">Acceptable Use Policy</h2>
                </div>
              ...
              <section>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg font-semibold">Email Compliance Requirements</h2>
                </div>
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Consent:</strong> You must have explicit consent from all email recipients before sending 
                    them emails through our Service.
                  </p>
                  <p>
                    <strong className="text-foreground">Unsubscribe:</strong> You must provide a clear and easy way for recipients to unsubscribe 
                    from your emails and honor all unsubscribe requests promptly.
                  </p>
                  <p>
                    <strong className="text-foreground">Identification:</strong> Your emails must clearly identify you as the sender and include 
                    accurate contact information.
                  </p>
                  <p>
                    <strong className="text-foreground">Content Guidelines:</strong> Email content must be truthful and not misleading. Subject 
              ...
              <section>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-lg font-semibold">Service Limitations</h2>
                </div>
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">Gmail API Limits:</strong> Our Service is subject to Google Gmail API rate limits and 
                    quotas. We cannot guarantee unlimited email sending capacity.
                  </p>
                  <p>
                    <strong className="text-foreground">Account Suspension:</strong> We reserve the right to suspend or terminate accounts that 
                    violate these Terms or engage in abusive behavior.
                  </p>
                  <p>
                    <strong className="text-foreground">Service Availability:</strong> While we strive for high availability, we do not guarantee 
              ...
              <section>
                ...
                <div className="bg-muted/50 p-4 rounded-lg mt-3">
                  <p className="text-sm">
                    <strong>Email:</strong> <span className="text-muted-foreground">adityamer.work@gmail.com</span>
                  </p>
                </div>
              </section>
            </div>
