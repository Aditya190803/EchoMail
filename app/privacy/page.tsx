      ...
      <main className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
        <Card className="shadow-lg border-0">
          <CardHeader className="text-center pb-2">
            <CardTitle className="text-2xl sm:text-3xl font-bold mb-2">Privacy Policy</CardTitle>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium mb-2">Google Account Information</h3>
              ...
              <section>
                ...
                <div className="space-y-3 text-muted-foreground">
                  <p>
                    <strong className="text-foreground">No Permanent Storage:</strong> We do not permanently store your email content, recipient 
                    lists, or campaign data. Information is processed temporarily during email sending only.
                  </p>
                  <p>
                    <strong className="text-foreground">Secure Transmission:</strong> All data transmission between your browser and our servers is 
                    encrypted using industry-standard TLS encryption.
                  </p>
                  <p>
                    <strong className="text-foreground">OAuth Security:</strong> We use Google's secure OAuth 2.0 authentication, which means 
                    we never have access to your Gmail password.
                  </p>
                  <p>
                    <strong className="text-foreground">Limited Access:</strong> We only request the minimum necessary permissions to send 
