    ...
    switch (email.status) {
      case 'pending':
        if (isPast(new Date(email.scheduled_at))) {
          return <Badge variant="warning" className="flex items-center gap-1"><AlertCircle className="h-3 w-3" /> Overdue</Badge>
        }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-muted-foreground">Loading scheduled emails...</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold mb-2">Scheduled Emails</h1>
            <p className="text-muted-foreground">Manage your scheduled email campaigns</p>
          </div>
          <Button asChild>
            <Link href="/compose">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          <DropdownMenuItem onClick={() => sendNow(email)}>
            ...
            <CardContent className="py-16">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6 max-w-sm mx-auto">
                  Schedule your email campaigns for future delivery
                </p>
                <Button asChild>
                  <Link href="/compose">
                    <Send className="h-4 w-4 mr-2" />
