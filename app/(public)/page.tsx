...
const features = [
  {
    ...
    description: "Upload any CSV and auto-map columns to template variables. Unlimited custom fields, zero config.",
    accent: "text-blue-500", bg: "bg-blue-500/10",
  },
  {
    icon: Sparkles,
    title: "Rich Text Editor",
    description: "WYSIWYG editor with real-time personalization preview. Format, link, and embed images effortlessly.",
    accent: "text-violet-500", bg: "bg-violet-500/10",
  },
  {
    icon: Send,
    title: "Gmail Integration",
    description: "Send directly via your Gmail account through Google's official API. Protect your sender reputation.",
    accent: "text-orange-500", bg: "bg-orange-500/10",
  },
  {
    icon: Zap,
    title: "Bulk Sending",
    description: "Send thousands of personalised emails in one click with live progress tracking built in.",
    accent: "text-yellow-500", bg: "bg-yellow-500/10",
  },
  {
    icon: Shield,
    title: "Secure & Private",
    description: "OAuth 2.0 authentication. Your data never leaves your account. Fully GDPR-compliant.",
    accent: "text-emerald-500", bg: "bg-emerald-500/10",
  },
  {
    icon: BarChart3,
    title: "Real-time Analytics",
    description: "Track delivery, opens, and clicks live. Export detailed campaign reports anytime.",
    accent: "text-pink-500", bg: "bg-pink-500/10",
  },
];

const steps = [
  { step: "01", icon: Lock,  title: "Connect Gmail",       description: "Sign in with Google — your account connects securely via OAuth in seconds." },
  { step: "02", icon: Users, title: "Upload Recipients",   description: "Drag & drop your CSV. Column names become personalisation variables automatically." },
  { step: "03", icon: Send,  title: "Send & Track",        description: "Compose, preview every email, then send. Watch delivery happen in real-time." },
];
...
function Reveal({ children, className = "", delay = 0 }: {
  ...
  return (
    <div ref={ref} className={`reveal-block ${className}`}>{children}</div>
  );
}
      ...
      <div className="min-h-screen">
        ...
        <section className="relative overflow-hidden">
          ...
          <div aria-hidden className="pointer-events-none absolute inset-0 -z-10"
            style={{ background: "radial-gradient(ellipse 70% 60% at 60% 0%, oklch(0.6231 0.188 259.8145 / 0.13) 0%, transparent 70%)" }} />
          {/* dot grid */}
          <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 opacity-[0.03]"
            style={{ backgroundImage: "radial-gradient(var(--color-foreground) 1px, transparent 1px)", backgroundSize: "28px 28px" }} />
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="space-y-7">
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.08] text-balance">
                  Send{" "}
                  <span style={{
                    background: "linear-gradient(135deg, oklch(0.6231 0.188 259.8145) 0%, oklch(0.55 0.22 290) 100%)",
                ...
                <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-muted-foreground pt-1">
                  {["No credit card required", "Free to start", "GDPR compliant", "Open source"].map(t => (
              ...
              <div className="relative">
                {/* glow behind demo */}
                <div aria-hidden className="absolute -inset-6 -z-10 rounded-3xl blur-3xl opacity-15"
                  ...
                  <Reveal key={i} delay={i * 80}>
                    <div className="relative flex flex-col gap-4">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-4xl font-black text-muted/20 tabular-nums leading-none">{item.step}</span>
                      </div>
                      <div>
          ...
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <Reveal>
              <div className="relative rounded-2xl border bg-card overflow-hidden text-center p-10 md:p-16">
                {/* soft gradient */}
                <div aria-hidden className="pointer-events-none absolute inset-0 -z-10"
                  style={{ background: "radial-gradient(ellipse 80% 60% at 50% 110%, oklch(0.6231 0.188 259.8145 / 0.10) 0%, transparent 70%)" }} />
                ...
                <h2 className="text-3xl sm:text-4xl font-bold mb-4">Ready to reach your audience?</h2>
                <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
                  Sign in with Google and send your first personalised campaign in under five minutes.
                </p>
