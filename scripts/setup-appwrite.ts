...
const collections = [
  ...
  },
  {
    ...
    attributes: [
      ...
      { key: 'variant_a_content', type: 'string', size: 100000, required: false },
      { key: 'variant_b_subject', type: 'string', size: 500, required: false },
      { key: 'variant_b_content', type: 'string', size: 100000, required: false },
      { key: 'variant_a_recipients', type: 'string', size: 500000, required: false },
      { key: 'variant_b_recipients', type: 'string', size: 500000, required: false },
